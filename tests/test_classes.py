...
class TestCycleTimesParser(unittest.TestCase):
    def test_cycle_times_valid_case(self):
        path = os.path.dirname(os.path.abspath(__file__))
        parsed_cycle_times = classes.CycleTimesParser(os.path.join(path, '../test_data/150424_ST-E00214_0031_BH2WY7CCXX/Logs/CycleTimes.txt'))
        expected_cycle_times_data = [{'start': datetime.datetime(2019, 5, 20, 15, 3, 22, 11000),
                                      'cycle_number': 1,
    ...
    def test_cycle_times_file_empty(self):
        path = os.path.dirname(os.path.abspath(__file__))
        parsed_cycle_times = classes.CycleTimesParser(os.path.join(path, '../test_data/191018_ST-E00214_0031_BH2WY7CCXX/Logs/CycleTimes.txt'))
        assert parsed_cycle_times.cycles == []

    def test_cycle_times_file_missing(self):
        path = os.path.dirname(os.path.abspath(__file__))
        with self.assertRaises(OSError):
            parsed_cycle_times = classes.CycleTimesParser(os.path.join(path, '../test_data/191018_ST-E00214_0031_BH2WY7CCXX/Logs/missing_CycleTimes.txt'))


class TestRunParser(unittest.TestCase):
    def test_runfolder_valid_case(self):
        path = os.path.dirname(os.path.abspath(__file__))
        parsed_run = classes.RunParser(os.path.join(path, '../test_data/150424_ST-E00214_0031_BH2WY7CCXX'))
    ...
    def test_runfolder_empty(self):
        path = os.path.dirname(os.path.abspath(__file__))
        parsed_run = classes.RunParser(os.path.join(path, '../test_data/191023_ST-E00214_0031_BH2WY7CCXX'))
    ...
    def test_missing_runfolder(self):
        path = os.path.dirname(os.path.abspath(__file__))
        with self.assertRaises(OSError):
            parsed_run = classes.RunParser(os.path.join(path, '../test_data/missing-191023_ST-E00214_0031_BH2WY7CCXX'))
